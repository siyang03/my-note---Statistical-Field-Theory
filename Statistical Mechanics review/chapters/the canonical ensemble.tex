...
\subsection{quantum mechanically} \label{3.6.2}
\begin{itemize}
	\item 每个谐振子有如下能级,
	\begin{equation}
...
\section{the statistics of paramagnetism} \label{3.7}
\begin{itemize}
...
\subsection{classically (Langevin paramagnetism)}
\begin{itemize}
...
\subsection{quantum mechanically (Brillouin paramagnetism)}
\begin{itemize}
