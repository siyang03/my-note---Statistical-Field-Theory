\chapter{ideal Fermi systems} \label{8}
\begin{itemize}
...
\section{thermodynamic behavior of an ideal Fermi gas} \label{8.1}
\begin{itemize}
...
\section{magnetic behavior of an ideal Fermi gas} \label{8.2}
\begin{itemize}
...
\section{the electron gas in metals} \label{8.3}
\begin{itemize}
...
\section{relativistic electron gas: white dwarf stars}
\begin{itemize}
