...
% use \vcenter{\hbox{\includegraphics[scale=1]{figures/...}}} to insert figures (e.g. Feynman diagrams) in equation environment.
%----------------------------------------------------------------------
...
\begin{document}
	...
	\import{chapters/}{ideal Bose systems}
	
	\import{chapters/}{ideal Fermi systems}
	
	\part{more advanced topics}
	
	\import{chapters/}{thermodynamics of the early universe}
	
	\import{chapters/}{the cluster expansion}
	
	\part{phase transition}
	
	\import{chapters/}{phase transitions - criticality, universality, and scaling}
