...
%----------------------------------------------------------------------
\title{\Huge \textbf{Statistical Field Theory}}
...
\begin{document}
	...
	\part{thermodynamics and statistical physics}
	
	\import{chapters/}{fundamentals of statistical mechanics}
	
	\part{statistical field theory}
	
	\import{chapters/}{the Ising model}
